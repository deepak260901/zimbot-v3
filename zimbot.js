...
break
	    ...
	    if (isBan) throw mess.ban
                ZimBotInc.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/4e12bdfc0fbcbe7d14930.jpg' }, caption: `*Hi Chomie ${m.pushName}*\n\n *Thanks for your support we appreciate you we dont need your money, support us by subscribing to our youtube channel* *DRIPS OFC:* http://instagram.com/_g.a.p.p.u_ ` }, { quoted: m })
            }
            break            
            case 'chat': {
                if (!isCreator) throw mess.owner
...
url: 'http://instagram.com/_g.a.p.p.u_'
}
}, {
urlButton: {
displayText: 'GITHUB',
...
╰━━━━━━━━━━━━━━━━━━╯`,
      ...
      const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url : `http://instagram.com/_g.a.p.p.u_` } }, { urlButton: { displayText: `GITHUB`, url : `https://www.facebook.com/profile.php?id=100015805215445` } },
   {					
					quickReplyButton: {
						displayText: 'SPEED',
						id: 'ping'
